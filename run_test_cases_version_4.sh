...
do echo "*********"; echo; echo; echo $i; 
    /asterias-web-apps/adacgh-server/runADaCGHserver-4.py /asterias-web-apps/adacgh-server/runs-tmp/tmp-3/$i;
done
...
do echo "*********"; echo; echo; echo $i; 
    /asterias-web-apps/adacgh-server/runADaCGHserver-4.py /asterias-web-apps/adacgh-server/runs-tmp/tmp-3-older-format/$i;
done
...
do echo "*********"; echo; echo; echo $i; 
    /asterias-web-apps/adacgh-server/runADaCGHserver-4.py /asterias-web-apps/adacgh-server/runs-tmp/tmp-3-several-identical/$i;
done
...
do cd ./runs-tmp/tmp-3/$i; 
    ...
    cat R_Status.txt; 
    cd /asterias-web-apps/adacgh-server; 
done
